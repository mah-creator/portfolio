...
A visitor clicks on a project card to view more detailed content (description, deliverables, tech tags, and images) in a smooth, high-fidelity overlay modal.
...
**Acceptance Scenarios**:
1. **Given** the user is looking at the project showcase grid, **When** they click on a project card, **Then** a modal opens displaying the project's full description, deliverables, and role.
...
- **FR-004**: The project showcase grid MUST display cards containing project title, a short subtitle, tags, and a thumbnail image.
...
- **Project**: Represents a portfolio project containing id, title, subtitle, category, tags (array of strings), description, deliverables (array of strings), image URL, and link.
